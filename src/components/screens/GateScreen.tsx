  ...
  return (
    <div className="gate-screen fade-in">
      ...
      <div className="gate-card soft-card">
        ...
        <h1 className="gate-title handwritten">Код подтверждения</h1>
        <p className="gate-text">
          Привет, солнышко! 
          <br />
          Чтобы продолжить, нужно подтвердить, что этот сайт открыла именно ты — моя самая родная, самая нежная и самая любимая
          <br />
          <br />
          Самая прекрасная девушка получила код подтверждения 14 февраля в 12:31 по индийскому времени в Telegram
          <br />
          <br />
          Внимательно присмотрись, введи те 4 цифры и приготовься погрузиться в ещё одно путешествие 💫
        </p>
